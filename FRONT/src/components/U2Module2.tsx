...
export default function U2Module2({ progress, updateProgress }: SharedProps) {
        ...
        <div className="p-12 relative flex items-center justify-center min-h-[400px]">
          {!isTerminal ? (
            ...
            <div className="text-center max-w-xl w-full">
              ...
              <p className="text-slate-600 bg-slate-50 p-6 rounded-2xl">{TERMINALS[current as string].detail}</p>
            </div>
          )}
        </div>
