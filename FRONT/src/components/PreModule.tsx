...
import { EXERCISES_ADMIN, EXERCISES_MECANICA, Exercise } from '../data/preModuleExercises';

type Specialty = 'mecanica' | 'administracion';

export default function PreModule({ progress, updateProgress, setScreen }: SharedProps) {
